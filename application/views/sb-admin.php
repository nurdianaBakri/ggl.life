    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url(); ?>">
                ...
                <div class="sidebar-brand-text mx-3">GGL LIFE</div>
            </a>
			...
			<li class="nav-item">
                <a class="nav-link" href="<?= base_url()."Soal1" ?>">
                    <i class="fas fa-fw fa-user-md"></i>
                    <span>Soal 1</span></a>
            </li>

			<li class="nav-item">
                <a class="nav-link" href="<?= base_url()."Soal2" ?>">
                    <i class="fas fa-fw fa-user-md"></i>
                    <span>Soal 2</span></a>
            </li>

			<li class="nav-item">
                <a class="nav-link" href="<?= base_url()."Soal3" ?>">
                    <i class="fas fa-fw fa-user-md"></i>
                    <span>Soal 3</span></a>
            </li>

			<li class="nav-item">
                <a class="nav-link" href="<?= base_url()."Table_barang" ?>">
                    <i class="fas fa-fw fa-user-md"></i>
                    <span>Barang</span></a>
            </li>

			<li class="nav-item">
                <a class="nav-link" href="<?= base_url()."Table_stok" ?>">
                    <i class="fas fa-fw fa-user-md"></i>
                    <span>Stok</span></a>
            </li>
